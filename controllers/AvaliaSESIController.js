...
async function createUser(req, res) {
  ...
  const { rm,Ebep, ComDeficiencia, Turma,PorcentagemAxertosIngles, CH, CN, LP, MAT} = req.body;
  try {
    // Chama o método do modelo para criar o novo usuário com os dados fornecidos
    await userModel.createUser(rm,Ebep, ComDeficiencia, Turma,PorcentagemAxertosIngles, CH, CN, LP, MAT );
...
async function updateUser(req, res) {
  ...
  try {
    ...
    await userModel.updateUser(rm,Ebep, ComDeficiencia, Turma,PorcentagemAxertosIngles, CH, CN, LP, MAT);
