...
async function createUser(req, res) {
  ...
  const { rm, nome, frequencia, notaCT, ano, etapa} = req.body;
  try {
    // Chama o método do modelo para criar o novo usuário com os dados fornecidos
    await userModel.createUser(rm, nome, frequencia, notaCT, ano, etapa );
...
async function updateUser(req, res) {
  ...
  const rm = req.params.rm;
  const { nome, frequencia, notaCT, ano, etapa} = req.body;
  try {
    // Chama o método do modelo para atualizar o usuário com base no ID e nos dados fornecidos
    await userModel.updateUser(rm, nome, frequencia, notaCT, ano, etapa);
