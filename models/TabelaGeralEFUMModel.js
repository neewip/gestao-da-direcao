...
AND Ano = ${Ano}
AND (NotaFinalCN < 7 OR NotaFinalLP < 7 OR NotaFinalAR < 7 OR NotaFinalEF < 7 OR NotaFinalCCE < 7 OR NotaFinalLI < 7 OR NotaFinalPF < 7 OR NotaFinalROB < 7 OR NotaFinalPR < 7 OR NotaFinalPSC < 7);'
